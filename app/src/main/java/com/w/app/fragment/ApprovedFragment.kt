...
class ApprovedFragment:BaseFragmnet() {
    ...
    override fun Init(view: View) {
        rvApproved=view.findViewById(R.id.rvApproved)
        ...
        rvApproved!!.addOnScrollListener(object : RecyclerView.OnScrollListener() {
        ...
        call.enqueue(object : Callback<ListResponse<WallpaperModel>> {
            override fun onResponse(
                ...
                if (response.code() == 200) {
                    ...
                    rvApproved!!.visibility=View.VISIBLE
                    ...
                    if (restResponce.getResponseCode().equals("1")) {
                        ...
                        if(!isFristPage){
                            ...
                            rvApproved!!.visibility=View.GONE
    ...
    fun setPendingAdaptor(
        ...
        if (isFristPage) {
            ...
            rvApproved!!.adapter = ImageAdaptor
            rvApproved!!.layoutManager = manager
            rvApproved!!.itemAnimator = DefaultItemAnimator()
            rvApproved!!.isNestedScrollingEnabled = false
        } else {
